...
Ошибка указывает на то, что функция \verb\assert_param()\, которая используется в библиотеке \textit{SPL} для проверки своих аргументов, объявлена неявно. Пользователю необходимо самому реализовать эту функцию проверки или использовать <<заглушку>>. Для устранения ошибки создайте файл \verb\stm32l1xx_conf.h\ содержащий:
...
Файл \verb\stm32l1xx_conf.h\ нужно будет подключать ко всем библиотекам, которые будут использоваться в проекте.
